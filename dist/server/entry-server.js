...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderComponent, ssrRenderSlot, renderToString } from "vue/server-renderer";
import { defineComponent, mergeProps, useSSRContext, unref, withCtx, createTextVNode, createVNode, createSSRApp } from "vue";
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "greetings" }, _attrs))} data-v-a47c673d><h1 class="green" data-v-a47c673d>${ssrInterpolate(_ctx.msg)}</h1><h3 data-v-a47c673d> You’ve successfully created a project with <a href="https://vitejs.dev/" target="_blank" rel="noopener" data-v-a47c673d>Vite</a> + <a href="https://vuejs.org/" target="_blank" rel="noopener" data-v-a47c673d>Vue 3</a>. What&#39;s next? </h3></div>`);
    };
  }
});
...
const HelloWorld = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-a47c673d"]]);
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  __name: "App",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><header data-v-85852c48><img alt="Vue logo" class="logo"${ssrRenderAttr("src", _imports_0)} width="125" height="125" data-v-85852c48><div class="wrapper" data-v-85852c48>`);
      _push(ssrRenderComponent(HelloWorld, { msg: "You did it!" }, null, _parent));
      _push(`<nav data-v-85852c48>`);
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-85852c48"]]);
const _sfc_main$7 = {};
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => import("./assets/AboutView-7-wtqAfi.js")
    }
  ]
});
function createApp() {
